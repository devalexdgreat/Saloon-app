...
import heroImg7 from '@/public/img7.jpg';
        ...
        <div className="w-full py-32" id="gallery">
            <div className="w-11/12 mx-auto">
                <div className="w-7/12 mx-auto mb-6">
                    <h1 className="text-2xl md:text-4xl font-bold text-center text-orange-500 mb-1">Gallery</h1>
                ...
                <div className="w-full columns-2 md:columns-3 [&>img:not(:first-child)]:mt-5 md:[&>img:not(first-child)]:mt-8">
                    ...
                    <Image src={heroImg7} className="border border-black rounded-3xl shadow-2xl shadow-black/50" alt="" />
                </div>
            </div>
        </div>
    );
