    ...
    return (
        <div className="w-full bg-black text-white absolute">
            <div className="w-11/12 mx-auto py-6 flex flex-col md:flex-row justify-between items-center gap-5 md:gap-0">
                <Link href={'#'} className="font-bold text-2xl text-orange-500">MS.</Link>
                <div className="flex flex-col md:flex-row gap-16">
                    <div className="flex flex-col leading-tight items-center md:items-start">
                        ...
                        <div className="flex gap-6">
                            <Link href={'#'} className="font-bold leading-loose hover:text-orange-500 duration-500" title="Call">Call</Link>
                            <Link href={'#'} className="font-bold leading-loose hover:text-orange-500 duration-500" title="Whatsapp">Whatsapp</Link>
